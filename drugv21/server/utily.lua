...
ESX.RegisterUsableItem('opium_bag', function(source)
        
    local _source = source
local xPlayer = ESX.GetPlayerFromId(_source)
xPlayer.removeInventoryItem('opium_bag', 1)
...
ESX.RegisterUsableItem('bag', function(source)
  ...
  ESX.RegisterUsableItem(Config.rawItem, function(source)
    ...
    xPlayer.addInventoryItem('joint', 1)
      TriggerClientEvent('rx_items:joint', source)
    TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'Zrobiłeś Jointa'})
